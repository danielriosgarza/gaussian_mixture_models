...
for i in bac:
    bac_prof[i][bac_prof[i]<(1./1000)]=0
...
K = 2
alpha = 7 #concentration parameter for the Dirichlet disrtibution
#Bulding test data
...
rcd = collapsed_gibbs_sampler(5000, bac_data_set, param_dict, mk_dict, coll_param_dict, alpha_0, K, N)
